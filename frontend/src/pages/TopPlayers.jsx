  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-white/70 backdrop-blur-sm flex flex-col items-center p-8 z-10">
        {/* Sticky Header with Play Again Button - Always visible at top */}
        <div className="w-full max-w-4xl mb-4 z-30 sticky top-0">
        ...
        {/* Scrollable Content */}
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-4xl w-full flex-1 overflow-y-auto">
          {error ? (
